    ...
    <body>
        ...
        <div id="login-container" class="animation-fadeIn">
            ...
            <div class="login-title text-center">
                <h1><i class="gi gi-flash"></i> <strong>Deshi Travels</strong><br><small>Please <strong>Login</strong></small></h1>
            </div>
            <!-- END Login Title -->
            ...
            <div class="block push-bit">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        $username = $fm->validation($_POST['user_name']);
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <div class="input-group">
                                ...
                                <input type="text" id="login-email" name="user_name" class="form-control input-lg" placeholder="Username">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
