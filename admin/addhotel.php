                        ...
                        <div class="row">
                           <?php 
                                ...
                                if ($hotel_name == "" || $hotel_type == "" || $hotel_address == "") {
                                    ...
                                    $query = "INSERT INTO  tbl_hotel(hotel_name, hotel_type, hotel_img, hotel_address) VALUES('$hotel_name', '$hotel_type', '$upload_image', '$hotel_address')";
                                    $hotelinsert = $db->insert($query);

                                    if ($hotelinsert) {
                                        echo"<span style='color:green;'>Hotel Add Successfully</span>";
                                    }else {
                                         echo"<span style='color:red;'>Hotel not Added</span>";
                                    }
                                }
                              }
                           ...
                           <form  action="" method="post" class="form-horizontal form-bordered ui-formwizard" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input id="hotel_name" name="hotel_name" class="form-control " placeholder="Enter Hotel Name.." type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-4 control-label" for="hotel_type">Hotel Type</label>
                                    <div class="col-md-5">
                                        <input id="hotel_type" name="hotel_type" class="form-control " placeholder="Enter Hotel Type.." type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <textarea name="hotel_address" class="form-control" placeholder="Enter Hotel Address.."></textarea>
                                    </div>
                                </div>
